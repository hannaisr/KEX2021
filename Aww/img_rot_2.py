...
IMG_SIZE0 = 90 # First dimension of image, should not be changed
...
# Constants
N_ROTATIONS = 1 # Number of rotations per image
...
def rotate_image(img):
    ...
    deg = rnd.gauss(0,10) # Uncomment for gaussian distribution
    ...
    new_img = ndimage.shift(img, [shift0, shift1], cval=255)
